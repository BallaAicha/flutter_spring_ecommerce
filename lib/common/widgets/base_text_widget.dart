...
Widget listItemContainer(
  ...
  return Container(
    ...
    child: Text(
      name,
      overflow: TextOverflow.clip,//pour que le texte soit coupé s'il est long
      maxLines: 1,
      style: TextStyle(
...
Widget searchView(BuildContext context, MySearchController searchController, String hintText, {bool home = true}) {
  return Row(
    children: [
      Container(
        width: 280.w,
            ...
            Container(
              ...
              child: TextField(
                ...
                onSubmitted: (value){
                  if(value.isNotEmpty){
                    if(home==false){
                      searchController.asyncLoadSearchData(value);
                    }
                  }
                },
                autocorrect: false,
