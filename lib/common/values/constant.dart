class AppConstants{
  ...
  static const String SERVER_API_URL = "http://192.168.0.181:9098/realms/ecommerce/protocol/openid-connect/token";
  ...
  static const String SERVER_API_URL_BACKEND = "http://192.168.0.181:8222/api/v1";
